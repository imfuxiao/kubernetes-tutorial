...
import (
	...
	"github.com/imfuxiao/kubernetes-tutorial/custom-resource-definetion/k8s-controller-crd-resource/pkg/client/clientset/versioned/scheme"
...
// CrdV1alpha1Client is used to interact with features provided by the crd.fuxiao.dev group.
type CrdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrdV1alpha1Client) Etcds(namespace string) EtcdInterface {
