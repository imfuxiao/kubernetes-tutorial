...
import (
	...
	etcdv1alpha1 "github.com/imfuxiao/kubernetes-tutorial/custom-resource-definetion/k8s-controller-crd-resource/pkg/apis/etcd/v1alpha1"
	versioned "github.com/imfuxiao/kubernetes-tutorial/custom-resource-definetion/k8s-controller-crd-resource/pkg/client/clientset/versioned"
	internalinterfaces "github.com/imfuxiao/kubernetes-tutorial/custom-resource-definetion/k8s-controller-crd-resource/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/imfuxiao/kubernetes-tutorial/custom-resource-definetion/k8s-controller-crd-resource/pkg/client/listers/etcd/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha1().Etcds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha1().Etcds(namespace).Watch(context.TODO(), options)
			},
		},
		&etcdv1alpha1.Etcd{},
		resyncPeriod,
...
func (f *etcdInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdv1alpha1.Etcd{}, f.defaultInformer)
}
